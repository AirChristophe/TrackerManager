...
export default function Page() {
  ...
  const _fetchData = async () => {
    ...
    const url =
      "https://splanner.georacing.com/trackers/getTrackerDetailByName/" +
      params.name;
  ...
  const _addTrackerMessage = async () => {
    ...
    fetch(
      "https://splanner.georacing.com/trackers/addTrackerManagementMessage",
      {
        method: "POST",
        headers: new Headers({
          "Content-Type": "application/x-www-form-urlencoded",
  ...
  const _delTrackerMessage = async (tracker_management_message_id) => {
    ...
    fetch(
      "https://splanner.georacing.com/trackers/delTrackerManagementMessage",
      {
        method: "POST",
        headers: new Headers({
          "Content-Type": "application/x-www-form-urlencoded",
    ...
    <>
      ...
      <View style={styles.container}>
        ...
        <View style={{}}>
          <Text
            style={[
              data?.quality == "VERYGOOD" || data?.quality == "GOOD"
                ? { color: "green" }
                : data?.quality == "POOR"
                ? { color: "orange" }
                : { color: "red" },
        ...
        <View style={styles.row}>
          ...
          <View style={styles.right}>
            <Text style={styles.text_right}>{data?.id_provider_tracker}</Text>
          </View>
        </View>
        ...
        <View style={styles.row}>
          ...
          <View style={styles.right}>
            {data?.quality != "VERYGOOD" && (
              <Pressable
                style={styles.button}
                onPress={() => _setQualityTracker("VERYGOOD")}
              >
            ...
            {data?.quality != "GOOD" && (
              <Pressable
                style={styles.button}
                onPress={() => _setQualityTracker("GOOD")}
              >
            ...
            {data?.quality != "POOR" && (
              <Pressable
                style={styles.button}
                onPress={() => _setQualityTracker("POOR")}
              >
            ...
            {data?.quality != "BROKEN" && (
              <Pressable
                style={styles.button}
                onPress={() => _setQualityTracker("BROKEN")}
              >
            ...
            {data?.quality != "CHECK" && (
              <Pressable
                style={styles.button}
                onPress={() => _setQualityTracker("CHECK")}
              >
        ...
        <View style={styles.row}>
          ...
          <View style={styles.right}>
            <Text style={styles.text_right}>{data?.sim_id}</Text>
          </View>
        </View>
            ...
            <View style={styles.itemRow}>
              <View style={{ flexDirection: "row" }}>
                <Text style={styles.itemDate}>
                  {Moment(item.tracker_management_messages.created).format(
                    "YYYY-MM-DD"
                  )}{" "}
                </Text>
                <Text style={styles.itemText}>
                  {item.tracker_management_messages.message}
                </Text>
                <Pressable
                  style={styles.button_del}
                  onPress={() =>
                    _delTrackerMessage(item.tracker_management_messages.id)
                  }
                >
